...
class FileContentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'FK_file_contents_files_id' => ['type' => 'index', 'columns' => ['file_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'UK_file_contents_id' => ['type' => 'unique', 'columns' => ['id'], 'length' => []],
            'FK_file_contents_files_id' => ['type' => 'foreign', 'columns' => ['file_id'], 'references' => ['files', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
